...
var file_geecachepb_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2f, 0x67, 0x65, 0x65, 0x43, 0x61, 0x63, 0x68, 0x65,
...
func file_geecachepb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_geecachepb_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_geecachepb_proto_msgTypes[1].Exporter = func(v any, i int) any {
